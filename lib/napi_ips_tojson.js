...
var fs = require('fs');
var outstream = fs.createWriteStream("napi_ips_keys.json", {flags : 'w' });
...
var db_RTT = "napi_ips_s";
var db_LCT = "napi_ips_r";
var db_HCT = "napi_ips_m";
...
outstream.open();
var napi_ips_json = JSON.stringify(keys);
outstream.write(napi_ips_json);
