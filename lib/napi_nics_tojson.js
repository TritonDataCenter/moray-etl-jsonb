...
var fs = require('fs');
var outstream = fs.createWriteStream("napi_nics_keys.json", {flags : 'w' });
...
var db_RTT = "napi_nics_s";
var db_LCT = "napi_nics_r";
var db_HCT = "napi_nics_m";
...
outstream.open();
var napi_nics_json = JSON.stringify(keys);
outstream.write(napi_nics_json);
