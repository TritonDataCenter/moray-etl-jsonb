...
// vmapi_keys_tojson.js  //
// TARGET PostgreSQL tags and source Moray tag definitions//
// to json input 

var fs = require('fs');
var outstream = fs.createWriteStream("vmapi_keys.json", {flags : 'w' });
...
var db_RTT = "vmapi_vms_s";
var db_LCT = "vmapi_vms_r";
var db_HCT = "vmapi_vms_m";
...
outstream.open();
var vmapi_json = JSON.stringify(keys);
outstream.write(vmapi_json);
