...
// napi_nic_tags_tojson.js  //
// TARGET PostgreSQL tags and source Moray tag definitions //
// to json input

var fs = require('fs');
var outstream = fs.createWriteStream('napi_nic_tags_keys.json', {flags : 'w' });


// Output filenames
var f_db_HCT = '_m.json';
var db_HCT = 'napi_nic_tags_m';
...
outstream.open();
var napi_nic_tags_json = JSON.stringify(keys);
outstream.write(napi_nic_tags_json);
//exports.keys = keys;
